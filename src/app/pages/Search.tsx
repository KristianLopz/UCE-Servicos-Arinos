...
import { prestadores, categorias, bairros } from "../data/mockData";
...
export function Search({ onNavigate, initialQuery = "", initialCategoria = "" }: SearchProps) {
  ...
  const resultados = useMemo(() => {
    ...
    return lista;
  }, [query, categoriaFiltro, bairroFiltro, ordenacao]);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <p className="text-muted-foreground text-sm mb-6">Encontre o profissional certo para você em Arinos</p>
